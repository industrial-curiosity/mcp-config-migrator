...
- Choosing "Yes" or "Yes, always" also prompts for the backup storage location (editable, defaulting to the current effective location); after any backup actually occurs — including the silent "always back up" path — the storage location it was written to is displayed.
